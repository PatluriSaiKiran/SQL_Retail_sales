...
-- and quantity sold is more thaN or equal to 4 in the month of nov-22
...
-- Q.6 write a SQL query to find the total number of transactions(tranactions_id) made by each gender in each category
